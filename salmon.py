...
<< << << < .merge_file_ylVy1d
    ...
    salmon_index = "salmon index --index " + index + \
...
<< << << < .merge_file_ylVy1d
        ...
        print "missing:", file2
    salmon_string = "salmon quant -i " + index + " --libType IU -1 " + \
        file1 + " -2 " + file2 + " -o " + salmondir + sra + ".quant"
...
def sim_link(salmondir, sra):
    ...
    link_command = "cp " + salmondir + sra + \
        ".quant.counts " + counts_files_dir + sra + ".counts"
    print link_command
