...
# convert diamond blast output .daa files into tab-separated txt files for
# OrthoFinder
    ...
    with open(failed_file, "rU") as failed_file_lines:
        ...
        # grabs remained of processes
            if (not os.path.isfile(output_filename)):
                ...
                ortho_command = run_diamond_loop(
                    diamond_dir, workingdir, diamond_out_dir, species_file, db_filename)
                print ortho_command
                s = subprocess.Popen(ortho_command, shell=True)
                s.wait()
                diamond_view_command = run_diamond_view_failed(
                    diamond_out_dir, output_filename, species_db_filename)
