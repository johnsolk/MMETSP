...
def execute(data_frame1, data_frame2, dib_assemblies_dir,ncgr_assemblies_dir,output_dir1,output_dir2):
    assemblies1 = os.listdir(dib_assemblies_dir)
    assemblies2 = os.listdir(ncgr_assemblies_dir)
    finished = []
    comparisons = []
        ...
        if item.startswith("MMETSP"):
            ...
            if mmetsp not in special_flowers:
                ...
                if len(reverse_assembly)==0:
                    print("Assembly not present:",mmetsp,ncgr_assemblies_dir)
                else:
                    #print(reverse_assembly)
                    reverse_trinity_fasta = ncgr_assemblies_dir + reverse_assembly[0]
                    trinity_fasta = dib_assemblies_dir + item
                    ...
                    if os.path.isfile(trinity_fasta):
                        ...
                        if os.path.isfile(transrate_assemblies_ref):
                            ...
                            print("Running...")
                            transrate(output_dir1, mmetsp, trinity_fasta, dib_assemblies_dir, reverse_trinity_fasta)
                        if os.path.isfile(transrate_reverse_assemblies):
                            ...
                            transrate_reverse(output_dir2, mmetsp, trinity_fasta, dib_assemblies_dir, reverse_trinity_fasta)
                    else:
...
ncgr_assemblies_dir = "/mnt/research/ged/lisa/mmetsp/imicrobe/nt/"
...
dib_assemblies_dir = "/mnt/home/ljcohen/mmetsp_assemblies_trinity_2.2.0_redoMarch2018/"
...
output_dir1 = "/mnt/home/ljcohen/mmetsp_transrate_reference_dibredoMarch2018_v_ncgr/"
output_dir2 = "/mnt/home/ljcohen/mmetsp_transrate_reference_ncgr_v_dibredoMarch2018/"
...
data_frame1, data_frame2 = execute(data_frame1, data_frame2, dib_assemblies_dir,ncgr_assemblies_dir,output_dir1,output_dir2)
data_frame1.to_csv("assembly_evaluation_data/transrate_reference_dibredoMarch2018_v_ncgr.nt.csv")
data_frame2.to_csv("assembly_evaluation_data/transrate_reverse_ncgr.nt_v_dibredoMarch2018.csv")
print("Reference scores written: assembly_evaluation_data/transrate_reference_dibredoMarch2018_v_ncgr.nt.csv")
print("Reverse reference scores written: assembly_evaluation_data/transrate_reverse_ncgr.nt_v_dibredoMarch2018.csv")
